...
empty-all-mail-body = Aquí aparece el correo de todas las carpetas, excepto Correo no deseado y Papelera.
...
sidebar-folders-help = El número junto a cada carpeta.
...
cmd-search = Buscar
cmd-save-search = Guardar esta búsqueda…
search-save = Guardar
saved-search-placeholder = Nombre de esta búsqueda
saved-search-failed = No se pudo guardar la búsqueda: { $error }
search-menu = Más para { $name }
search-rename = Cambiar nombre
move-up = Subir
move-down = Bajar
rename-title = Cambiar el nombre de «{ $name }»
search-delete = Eliminar
saved-search-deleted = Se eliminó «{ $name }»
saved-search-saved = Se guardó «{ $name }»
saved-search-renamed = Renombrado a «{ $name }»
saved-search-moved-up = Se movió arriba
saved-search-moved-down = Se movió abajo
search-delete-confirm = ¿Eliminar «{ $name }»?
search-delete-body = Se elimina la búsqueda; tu correo no se toca.
...
settings-lists = Lista de mensajes
...
help-together-note = De Sam, desde junio, con archivo adjunto, que mencione el anexo.
help-boolean-note = De Sam o de Dana, que mencione la factura, pero no la palabra draft.
close = Cerrar
cancel = Cancelar
create = Crear
...
search-cut-terms = Solo se buscan los primeros { $count } términos.
search-cut-value = De cada término solo se buscan los primeros { $count } caracteres.
sort-by = Orden
...
lists-sort-scope = Orden
sort-scope-mailbox = Por buzón
sort-scope-everywhere = Compartido
...
invite-answered-quietly = { $response }. No se avisó al organizador.
invite-options = Opciones para { $answer }
invite-send-now = Enviar una respuesta ahora
invite-dont-send = No enviar una respuesta
folder-move = Mover…
...
palette-search-all = Buscar “{ $query }” en todo el correo
...
palette-save-search = Guardar búsqueda
palette-more = { $count ->
...
search-op-annex-pricing = correos con ambas palabras
search-op-after = esta fecha o después
search-op-before = antes de esta fecha
search-op-board-pack = esta frase exacta
search-op-cc = cualquiera en copia
search-op-date = este día, mes o año
search-op-draft = deja fuera esa palabra
search-op-filename = el nombre de un archivo adjunto
search-op-from = nombre o dirección del remitente
search-op-group-1 = Quién y qué
search-op-group-2 = Dónde y cómo
search-op-group-3 = Cuándo
...
search-chip-tagged = Con la etiqueta { $where }
...
search-chip-as-words = Buscar “{ $words }”
appearance-search-highlight = Resaltar coincidencias de búsqueda
settings-search = Búsqueda
search-in-mailbox = Aplicar automáticamente el filtro del contexto actual
search-in-mailbox-help = Por ejemplo in:inbox, in:Receipts o tag:urgent
search-chips = Mostrar pastillas de filtro en la búsqueda
search-highlight-on = Activado
search-highlight-off = Desactivado
search-op-or = cualquiera de los dos
search-op-and = ambos, igual que un espacio
search-op-not = sin, igual que un menos
search-op-brackets = agrupar términos
