...
search-op-annex-pricing = correos que contienen ambas palabras. Un espacio equivale a AND
search-op-after = enviados en esta fecha o después
search-op-before = enviados antes de esta fecha
search-op-board-pack = la frase exacta: estas palabras juntas y en este orden
search-op-cc = cualquiera en copia
search-op-date = enviados ese día. También vale un mes o un año
search-op-draft = excluye los correos que contienen esta palabra. También sirve con filtros, como -from:sam
...
search-op-or = basta con que coincida uno de los dos lados (escríbelo en mayúsculas)
search-op-and = deben coincidir ambos lados, igual que un espacio
search-op-not = excluye lo que sigue, igual que un signo menos
search-op-brackets = agrupa términos, para que OR se aplique solo a lo que está dentro
