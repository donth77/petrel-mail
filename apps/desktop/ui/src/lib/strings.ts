...
export const en = {
  ...
  'outbox-unknown-2':
    'Petrel checked your Sent folder to find out and could not reach the server either. It will not be sent again on its own — that could deliver it twice.',
  'outbox-undo': 'Undo',
  ...
  'outbox-checked-absent': 'It was not sent. Retrying now — that is safe.',
  ...
  'rules-help':
    'Rules run on new mail as it lands in the inbox \u2014 top to bottom, every rule that matches. They never touch mail that is already here, and never run while old mail is being backfilled.',
  'rule-new': 'New rule',
  ...
  'settings-backup-help':
    'One file of preferences, accounts, servers, colours and signatures. Passwords are never in it — they stay in the keychain. Importing merges: nothing here is deleted by a file that does not mention it.',
