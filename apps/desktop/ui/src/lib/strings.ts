...
export const en = {
  ...
  'settings-backup-help':
    'One file holding your preferences, accounts, servers, colors and signatures. Passwords are never in it. They stay in the keychain. Importing merges what it finds, so nothing here is deleted by a file that does not mention it.',
