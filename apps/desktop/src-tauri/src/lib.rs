...
pub fn run() {
    ...
    let state = Arc::new(AppState {
        ...
        folder_seen: Mutex::new(std::collections::HashMap::new()),
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::searches::list_saved_searches,
            commands::searches::create_saved_search,
            commands::searches::update_saved_search,
            commands::searches::delete_saved_search,
            commands::searches::move_saved_search,
            commands::searches::reorder_saved_searches,
